...
/// <summary>
/// AF Agent: Institutional-grade execution trader. Places orders via Alpaca,
/// persists <see cref="TradeDocument"/> to RavenDB for lifecycle tracking,
/// and exposes tools for order status checking and cancellation.
/// </summary>
public class ExecutionHound
{
        ...
        ILoggerFactory? loggerFactory = null)
    {
        ...
        _agent = new ChatClientAgent(
            chatClient,
            instructions: """
                You are ExecutionHound, an institutional-grade execution trader.
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var session2 = await _agent.CreateSessionAsync(cancellationToken);
        ...
        try
        {
            ...
            // Return result with TradeDocumentId attached
